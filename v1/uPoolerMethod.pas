...
Uses Datasnap.DSProxyRest, Datasnap.DSClientRest, Data.DBXCommon,
  ...
  Soap.EncdDecd,
  uRestCompressTools, System.ZLib, REST.JSON, IdGlobal, System.JSON,
  System.NetEncoding;
...
Type
  ...
  Public
    ...
    Function EchoPooler(Value, Method_Prefix: String;
      Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
    ...
    Function PoolersDataSet(Method_Prefix: String;
      Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
      UserName: String = ''; Password: String = ''): TStringList;

    // Roda Comando SQL
    Function InsertValue(Pooler, Method_Prefix, SQL: String; Params: TParams;
      Var Error: Boolean; Var MessageError: String;
      Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
      UserName: String = ''; Password: String = ''): Integer;

    Function ExecuteCommand(Pooler, Method_Prefix, SQL: String; Params: TParams;
      Var Error: Boolean; Var MessageError: String; Execute: Boolean;
      Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
      UserName: String = ''; Password: String = ''): TFDJSONDataSets;

    Function ExecuteCommandJSON(Pooler, Method_Prefix, SQL: String;
      Params: TParams; Var Error: Boolean; Var MessageError: String;
      Execute: Boolean; Const ARequestFilter: String = '';
      TimeOut: Integer = 3000; UserName: String = ''; Password: String = '')
      : TJSONObject;

    Function InsertValuePure(Pooler, Method_Prefix, SQL: String;
      Var Error: Boolean; Var MessageError: String;
      Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
      UserName: String = ''; Password: String = ''): Integer;

    Function ExecuteCommandPure(Pooler, Method_Prefix, SQL: String;
      Var Error: Boolean; Var MessageError: String; Execute: Boolean;
      Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
      UserName: String = ''; Password: String = ''): TFDJSONDataSets;

    Function ExecuteCommandPureJSON(Pooler, Method_Prefix, SQL: String;
      Var Error: Boolean; Var MessageError: String; Execute: Boolean;
      Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
      UserName: String = ''; Password: String = ''): TJSONObject;

    // Executa um ApplyUpdate no Servidor
    Procedure ApplyChangesPure(Pooler, Method_Prefix, TableName, SQL: String;
      ADeltaList: TFDJSONDeltas; Var Error: Boolean; Var MessageError: String;
      Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
      UserName: String = ''; Password: String = '');

    Procedure ApplyChanges(Pooler, Method_Prefix, TableName, SQL: String;
      Params: TParams; ADeltaList: TFDJSONDeltas; Var Error: Boolean;
      Var MessageError: String; Const ARequestFilter: String = '';
      TimeOut: Integer = 3000; UserName: String = ''; Password: String = '');

    // Lista todos os Pooler's do Servidor
    Procedure GetPoolerList(Method_Prefix: String; Var PoolerList: TStringList;
      Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
      UserName: String = ''; Password: String = '');

    Procedure GetPoolerList_Cache(Method_Prefix: String;
      PoolerList: TStringList; Out PoolerList_Cache: IDSRestCachedTStringList;
      Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
      UserName: String = ''; Password: String = '');

    // StoredProc
    Procedure ExecuteProcedure(Pooler, Method_Prefix, ProcName: String;
      Params: TParams; Var Error: Boolean; Var MessageError: String;
      Const ARequestFilter: String = '');

    Procedure ExecuteProcedurePure(Pooler, Method_Prefix, ProcName: String;
      Var Error: Boolean; Var MessageError: String;
      Const ARequestFilter: String = '');
  ...
  TDSRestCachedTStringList = Class(TDSRestCachedObject<TStringList>,
    IDSRestCachedTStringList, IDSRestCachedCommand)
  End;
...
Const
  ...
  TSMPoolerMethodClient_PoolersDataSet: array [0 .. 0]
    of TDSRestParameterMetaData = ((Name: ''; Direction: 4; DBXType: 37;
    TypeName: 'TStringList'));

  TSMPoolerMethodClient_ExecuteCommand: array [0 .. 6]
    of TDSRestParameterMetaData = ((Name: 'Pooler'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'SQL'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'Params'; Direction: 1; DBXType: 23;
    TypeName: 'TParams'), (Name: 'Error'; Direction: 3; DBXType: 4;
    TypeName: 'Boolean'), (Name: 'MessageError'; Direction: 3; DBXType: 26;
    TypeName: 'string'), (Name: 'Execute'; Direction: 1; DBXType: 4;
    TypeName: 'Boolean'), (Name: ''; Direction: 4; DBXType: 37;
    TypeName: 'TFDJSONDataSets'));

  TSMPoolerMethodClient_ExecuteCommandJSON: array [0 .. 6]
    of TDSRestParameterMetaData = ((Name: 'Pooler'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'SQL'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'Params'; Direction: 1; DBXType: 23;
    TypeName: 'TParams'), (Name: 'Error'; Direction: 3; DBXType: 4;
  ...
  TSMPoolerMethodClient_ExecuteCommandPure: array [0 .. 5]
    of TDSRestParameterMetaData = ((Name: 'Pooler'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'SQL'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'Error'; Direction: 3; DBXType: 4;
    TypeName: 'Boolean'), (Name: 'MessageError'; Direction: 3; DBXType: 26;
    TypeName: 'string'), (Name: 'Execute'; Direction: 1; DBXType: 4;
    TypeName: 'Boolean'), (Name: ''; Direction: 4; DBXType: 37;
    TypeName: 'TFDJSONDataSets'));

  TSMPoolerMethodClient_ExecuteCommandPureJSON: array [0 .. 5]
    of TDSRestParameterMetaData = ((Name: 'Pooler'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'SQL'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'Error'; Direction: 3; DBXType: 4;
    TypeName: 'Boolean'), (Name: 'MessageError'; Direction: 3; DBXType: 26;
  ...
  TSMPoolerMethodClient_ApplyChangesPure: array [0 .. 5]
    of TDSRestParameterMetaData = ((Name: 'Pooler'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'TableName'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'SQL'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'ADeltaList'; Direction: 1; DBXType: 37;
    TypeName: 'TFDJSONDeltas'), (Name: 'Error'; Direction: 3; DBXType: 4;
    TypeName: 'Boolean'), (Name: 'MessageError'; Direction: 3; DBXType: 26;
    TypeName: 'string'));

  TSMPoolerMethodClient_ApplyChanges: array [0 .. 6]
    of TDSRestParameterMetaData = ((Name: 'Pooler'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'TableName'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'SQL'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'Params'; Direction: 1; DBXType: 23;
    TypeName: 'TParams'), (Name: 'ADeltaList'; Direction: 1; DBXType: 37;
    TypeName: 'TFDJSONDeltas'), (Name: 'Error'; Direction: 3; DBXType: 4;
    TypeName: 'Boolean'), (Name: 'MessageError'; Direction: 3; DBXType: 26;
    TypeName: 'string'));

  TSMPoolerMethodClient_InsertValuePure: array [0 .. 4]
    of TDSRestParameterMetaData = ((Name: 'Pooler'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'SQL'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'Error'; Direction: 3; DBXType: 4;
    TypeName: 'Boolean'), (Name: 'MessageError'; Direction: 3; DBXType: 26;
    TypeName: 'string'), (Name: ''; Direction: 4; DBXType: 6;
    TypeName: 'Integer'));

  TSMPoolerMethodClient_InsertValue: array [0 .. 5]
    of TDSRestParameterMetaData = ((Name: 'Pooler'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'SQL'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'Params'; Direction: 1; DBXType: 23;
    TypeName: 'TParams'), (Name: 'Error'; Direction: 3; DBXType: 4;
    ...
    TypeName: 'string'), (Name: ''; Direction: 4; DBXType: 6;
    TypeName: 'Integer'));
  TSMPoolerMethodClient_GetPoolerList: array [0 .. 0]
    of TDSRestParameterMetaData = ((Name: 'PoolerList'; Direction: 3;
    DBXType: 37; TypeName: 'TStringList'));

  TSMPoolerMethodClient_GetPoolerList_Cache: array [0 .. 0]
    of TDSRestParameterMetaData = ((Name: 'PoolerList'; Direction: 2;
    DBXType: 26; TypeName: 'String'));
  TSMPoolerMethodClient_ExecuteProcedure: array [0 .. 4]
    of TDSRestParameterMetaData = ((Name: 'Pooler'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'ProcName'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'Params'; Direction: 1; DBXType: 23;
    TypeName: 'TParams'), (Name: 'Error'; Direction: 3; DBXType: 4;
    TypeName: 'Boolean'), (Name: 'MessageError'; Direction: 3; DBXType: 26;
    TypeName: 'string'));

  TSMPoolerMethodClient_ExecuteProcedurePure: array [0 .. 3]
    of TDSRestParameterMetaData = ((Name: 'Pooler'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'ProcName'; Direction: 1; DBXType: 26;
    TypeName: 'string'), (Name: 'Error'; Direction: 3; DBXType: 4;
    TypeName: 'Boolean'), (Name: 'MessageError'; Direction: 3; DBXType: 26;
...
procedure TSMPoolerMethodClient.ExecuteProcedure(Pooler, Method_Prefix,
  ProcName: String; Params: TParams; Var Error: Boolean;
  Var MessageError: String; Const ARequestFilter: String);
Begin
  ...
  FExecuteProcedureCommand.Parameters[1].Value.SetWideString
    (EncodeStrings(ProcName, vEncoding));
  FExecuteProcedureCommand.Parameters[2].Value.SetDBXReader
    (TDBXParamsReader.Create(Params, FInstanceOwner), True);
...
Procedure TSMPoolerMethodClient.ExecuteProcedurePure(Pooler, Method_Prefix,
  ProcName: String; Var Error: Boolean; Var MessageError: String;
  Const ARequestFilter: String);
begin
  ...
  Begin
    ...
    FExecuteProcedurePureCommand.Prepare
      (TSMPoolerMethodClient_ExecuteProcedurePure);
  End;
  FExecuteProcedurePureCommand.Parameters[0].Value.SetWideString(Pooler);
  FExecuteProcedurePureCommand.Parameters[1].Value.SetWideString
    (EncodeStrings(ProcName, vEncoding));
  ...
  MessageError := FExecuteProcedurePureCommand.Parameters[3]
    .Value.GetWideString;
End;

Procedure TSMPoolerMethodClient.ApplyChangesPure(Pooler, Method_Prefix,
...
//  end;
  ...
  FApplyChangesPureCommand.Parameters[2].Value.SetWideString
    (EncodeStrings(SQL, vEncoding));
  If Not Assigned(ADeltaList) Then
    FApplyChangesPureCommand.Parameters[3].Value.SetNull
  Else
  Begin
    FMarshal := TDSRestCommand(FApplyChangesPureCommand.Parameters[3]
...
Begin
  ...
  Begin
    ...
    FGetPoolerListCommand_Cache.Prepare
      (TSMPoolerMethodClient_GetPoolerList_Cache);
  End;
  ...
  Else
  Begin
    FMarshal := TDSRestCommand(FGetPoolerListCommand_Cache.Parameters[0]
      .ConnectionHandler).GetJSONMarshaler;
    Try
      FGetPoolerListCommand_Cache.Parameters[0].Value.SetJSONValue
        (FMarshal.Marshal(PoolerList), True);
      If FInstanceOwner Then
        PoolerList.Free;
    Finally
      FreeAndNil(FMarshal);
  ...
  PoolerList_Cache := TDSRestCachedTStringList.Create
    (FGetPoolerListCommand_Cache.Parameters[0].Value.GetString);
End;

Procedure TSMPoolerMethodClient.GetPoolerList(Method_Prefix: String;
  Var PoolerList: TStringList; Const ARequestFilter: String = '';
  TimeOut: Integer = 3000; UserName: String = ''; Password: String = '');
Begin
  ...
  Else
  Begin
    FMarshal := TDSRestCommand(FGetPoolerListCommand.Parameters[0]
      .ConnectionHandler).GetJSONMarshaler;
    Try
      FGetPoolerListCommand.Parameters[0].Value.SetJSONValue
        (FMarshal.Marshal(PoolerList), True);
      If FInstanceOwner Then
        PoolerList.Free
    Finally
  ...
  Begin
    FUnMarshal := TDSRestCommand(FGetPoolerListCommand.Parameters[0]
      .ConnectionHandler).GetJSONUnMarshaler;
    Try
      PoolerList := TStringList
        (FUnMarshal.UnMarshal(FGetPoolerListCommand.Parameters[0]
...
Procedure TSMPoolerMethodClient.ApplyChanges(Pooler, Method_Prefix, TableName,
  SQL: String; Params: TParams; ADeltaList: TFDJSONDeltas; Var Error: Boolean;
  Var MessageError: String; Const ARequestFilter: String = '';
  TimeOut: Integer = 3000; UserName: String = ''; Password: String = '');
Begin
  ...
  FApplyChangesCommand.Parameters[2].Value.SetWideString
    (EncodeStrings(SQL, vEncoding));
  FApplyChangesCommand.Parameters[3].Value.SetDBXReader
    (TDBXParamsReader.Create(TParams(Params), FInstanceOwner), True);
  If Not Assigned(ADeltaList) Then
    FApplyChangesCommand.Parameters[4].Value.SetNull
  Else
  Begin
    FMarshal := TDSRestCommand(FApplyChangesCommand.Parameters[4]
      .ConnectionHandler).GetJSONMarshaler;
    Try
      FApplyChangesCommand.Parameters[4].Value.SetJSONValue
        (FMarshal.Marshal(ADeltaList), True);
      If FInstanceOwner Then
        ADeltaList.Free;
    Finally
  ...
  If FApplyChangesCommand <> Nil Then
  begin
    FreeAndNil(FApplyChangesCommand);
  end;
end;

function TSMPoolerMethodClient.ExecuteCommandPureJSON(Pooler, Method_Prefix,
  SQL: String; Var Error: Boolean; Var MessageError: String; Execute: Boolean;
  Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
  UserName: String = ''; Password: String = ''): TJSONObject;
var
  vJsonText : string;
begin
  ...
  begin
    ...
    FExecuteCommandPureJSONCommand.Text := Method_Prefix +
      '.ExecuteCommandPureJSON';
    FExecuteCommandPureJSONCommand.Prepare
      (TSMPoolerMethodClient_ExecuteCommandPureJSON);
  end;
  ...
  FExecuteCommandPureJSONCommand.Connection.LoginProperties.UserName :=
    UserName;
  FExecuteCommandPureJSONCommand.Connection.LoginProperties.Password :=
    Password;
  FExecuteCommandPureJSONCommand.Parameters[0].Value.SetWideString(Pooler);
  FExecuteCommandPureJSONCommand.Parameters[1].Value.SetWideString
    (EncodeStrings(SQL, self.vEncoding));
  FExecuteCommandPureJSONCommand.Parameters[2].Value.SetBoolean(Error);
  FExecuteCommandPureJSONCommand.Parameters[3].Value.SetWideString
    (MessageError);
  ...
  try
    ...
    MessageError := FExecuteCommandPureJSONCommand.Parameters[3]
      .Value.GetWideString;

    { Passa para uma variavel e depois fazer o parser para poder liberar
    o objeto de origem }
    vJsonText := TJSONObject(FExecuteCommandPureJSONCommand.Parameters[5]
...
Function TSMPoolerMethodClient.ExecuteCommandPure(Pooler, Method_Prefix,
  SQL: String; Var Error: Boolean; Var MessageError: String; Execute: Boolean;
  Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
  UserName: String = ''; Password: String = ''): TFDJSONDataSets;
Begin
  ...
  Begin
    ...
    FExecuteCommandPureCommand.Prepare
      (TSMPoolerMethodClient_ExecuteCommandPure);
  End;
  ...
  FExecuteCommandPureCommand.Parameters[1].Value.SetWideString
    (EncodeStrings(SQL, vEncoding));
  ...
  Begin
    If Not Execute Then
    Begin
      FUnMarshal := TDSRestCommand(FExecuteCommandPureCommand.Parameters[5]
        .ConnectionHandler).GetJSONUnMarshaler;
      Try
        If vCompression Then
        begin
          Result := TFDJSONDataSets
            (FUnMarshal.UnMarshal
            (DecompressJSON(FExecuteCommandPureCommand.Parameters[6]
            .Value.GetJSONValue(FInstanceOwner).ToJSON)))
        end
        else
        begin
          Result := TFDJSONDataSets
            (FUnMarshal.UnMarshal(FExecuteCommandPureCommand.Parameters[5]
            .Value.GetJSONValue(True)));
        end;
...
Function TSMPoolerMethodClient.ExecuteCommandJSON(Pooler, Method_Prefix,
  SQL: String; Params: TParams; Var Error: Boolean; Var MessageError: String;
  Execute: Boolean; Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
  UserName: String = ''; Password: String = ''): TJSONObject;
var
  vJsonText : string;
  vAuxParam : TParams;
Begin
  ...
  { Copia a referencia para evitar o free indevido do paramentro  }
  vAuxParam := nil;
  if Assigned(Params) then
  begin
    vAuxParam := TParams.Create(Params.Owner);
    vAuxParam.Assign(Params);
  end;
  ...
  Begin
    ...
    FExecuteCommandJSONCommand.Prepare
      (TSMPoolerMethodClient_ExecuteCommandJSON);
  End;
  ...
  FExecuteCommandJSONCommand.Parameters[1].Value.SetWideString
    (EncodeStrings(SQL, vEncoding));
  try
    FExecuteCommandJSONCommand.Parameters[2].Value.SetDBXReader
      (TDBXParamsReader.Create(TParams(vAuxParam), FInstanceOwner), True);
  except
  ...
  Try
    ...
    MessageError := FExecuteCommandJSONCommand.Parameters[4]
      .Value.GetWideString;

    { Passa para uma variavel e depois fazer o parser para poder liberar
    o objeto de origem }
    vJsonText := TJSONObject(FExecuteCommandJSONCommand.Parameters[6]
      .Value.GetJSONValue(FInstanceOwner)).ToJSON;
...
Function TSMPoolerMethodClient.InsertValuePure(Pooler, Method_Prefix,
  SQL: String; Var Error: Boolean; Var MessageError: String;
  Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
  UserName: String = ''; Password: String = ''): Integer;
begin
  Result := -1;
  ...
  FInsertValueCommandPure.Parameters[1].Value.SetWideString
    (EncodeStrings(SQL, vEncoding));
...
Function TSMPoolerMethodClient.InsertValue(Pooler, Method_Prefix, SQL: String;
  Params: TParams; Var Error: Boolean; Var MessageError: String;
  Const ARequestFilter: String = ''; TimeOut: Integer = 3000;
  UserName: String = ''; Password: String = ''): Integer;
begin
  ...
  FInsertValueCommand.Parameters[1].Value.SetWideString
    (EncodeStrings(SQL, vEncoding));
  FInsertValueCommand.Parameters[2].Value.SetDBXReader
    (TDBXParamsReader.Create(Params, FInstanceOwner), True);
...
Function TSMPoolerMethodClient.ExecuteCommand(Pooler: String;
  Method_Prefix: String; SQL: String; Params: TParams; Var Error: Boolean;
  Var MessageError: String; Execute: Boolean; Const ARequestFilter: String = '';
  TimeOut: Integer = 3000; UserName: String = ''; Password: String = '')
  : TFDJSONDataSets;
Begin
  Result := Nil;
  ...
  FExecuteCommandCommand.Parameters[1].Value.SetWideString
    (EncodeStrings(SQL, vEncoding));
  FExecuteCommandCommand.Parameters[2].Value.SetDBXReader
    (TDBXParamsReader.Create(Params, FInstanceOwner), True);
  ...
  Begin
    If Not Execute Then
    Begin
      FUnMarshal := TDSRestCommand(FExecuteCommandCommand.Parameters[6]
        .ConnectionHandler).GetJSONUnMarshaler;
      Try
        If vCompression Then
        begin
          Result := TFDJSONDataSets
            (FUnMarshal.UnMarshal
            (DecompressJSON(FExecuteCommandCommand.Parameters[6]
            .Value.GetJSONValue(FInstanceOwner).ToJSON)))
        end
        Else
        begin
          Result := TFDJSONDataSets
            (FUnMarshal.UnMarshal(FExecuteCommandCommand.Parameters[6]
            .Value.GetJSONValue(True)));
        end;
...
Begin
  If ZDecompressStr(Value, vValue) Then
    Result := TJSONObject.ParseJSONValue(CompressionDecoding.GetBytes(vValue),
      0) as TJSONObject
  Else
    Result := Nil;
End;
...
Begin
 ...
 // FApplyChangesPureCommand.DisposeOf;
  ...
  FGetPoolerListCommand.DisposeOf;
  FGetPoolerListCommand_Cache.DisposeOf;

  FExecuteProcedureCommand.DisposeOf;
  FExecuteProcedurePureCommand.DisposeOf;
